...
// /// Solving this minefield requires looking at at most this many fields at the same time.
// ///
// /// - `0` - The minefield is solved upon the first reveal.
// /// - `1` - Looking at single revealed fields and counting its neighbors is sufficient.
// /// - `N` - Mine placement must be deduced by looking at at most `N` revealed fields in parallel.
...
//     #[error("not solvable")]
//     Unsolvable,
//     #[error("too difficult to solve; requires difficulty >= {difficulty}")]
//     TooDifficult { difficulty: NonZeroUsize },
// }
